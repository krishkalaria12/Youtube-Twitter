    ...
    <div
            ...
            <div className="flex flex-wrap gap-y-2">
              <div className="w-full md:w-1/2 lg:w-full xl:w-1/2">
                <h1 className="text-lg text-gray-200 font-bold">Advanced React Patterns</h1>
                ...
                <div className="flex items-center justify-between gap-x-4 md:justify-end lg:justify-between xl:justify-end">
                  <div className="flex overflow-hidden rounded-lg border">
                    <button
                      ...
                      data-like="3050"
                      data-like-alt="3051">
                      <span className="inline-block text-white w-5 group-focus/btn:text-[#ae7aff]">
                        <svg
                    ...
                    <button
                      className="group/btn flex items-center gap-x-2 px-4 py-1.5 text-white after:content-[attr(data-like)] hover:bg-white/10 focus:after:content-[attr(data-like-alt)]"
                      data-like="20"
                      data-like-alt="21">
                      <span className="inline-block text-white w-5 group-focus/btn:text-[#ae7aff]">
                        <svg
